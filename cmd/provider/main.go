...
import (
	...
	apisCluster "github.com/crossplane-contrib/provider-redpanda/apis/cluster"
	apisNamespaced "github.com/crossplane-contrib/provider-redpanda/apis/namespaced"
	"github.com/crossplane-contrib/provider-redpanda/config"
	"github.com/crossplane-contrib/provider-redpanda/internal/clients"
	controllerCluster "github.com/crossplane-contrib/provider-redpanda/internal/controller/cluster"
	controllerNamespaced "github.com/crossplane-contrib/provider-redpanda/internal/controller/namespaced"
	"github.com/crossplane-contrib/provider-redpanda/internal/features"
	"github.com/crossplane-contrib/provider-redpanda/internal/version"
)
...
func main() {
	...
	kingpin.FatalIfError(apisCluster.AddToScheme(mgr.GetScheme()), "Cannot add cluster-scoped Redpanda APIs to scheme")
	kingpin.FatalIfError(apisNamespaced.AddToScheme(mgr.GetScheme()), "Cannot add namespaced Redpanda APIs to scheme")
	...
	if canSafeStart {
		...
		kingpin.FatalIfError(controllerCluster.SetupGated(mgr, clusterOpts), "Cannot setup cluster-scoped Redpanda controllers")
		kingpin.FatalIfError(controllerNamespaced.SetupGated(mgr, namespacedOpts), "Cannot setup namespaced Redpanda controllers")
	} else {
		log.Info("Provider has missing RBAC permissions for watching CRDs, controller SafeStart capability will be disabled")
		kingpin.FatalIfError(controllerCluster.Setup(mgr, clusterOpts), "Cannot setup cluster-scoped Redpanda controllers")
		kingpin.FatalIfError(controllerNamespaced.Setup(mgr, namespacedOpts), "Cannot setup namespaced Redpanda controllers")
	}
