...
type ACLInitParameters struct {
	...
	// (Boolean) When set to true, allows the resource to be removed from state even if the cluster is unreachable
	...
	// +crossplane:generate:reference:type=github.com/crossplane-contrib/provider-redpanda/apis/cluster/redpanda/v1alpha1.Topic
