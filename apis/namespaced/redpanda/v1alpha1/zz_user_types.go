...
type UserInitParameters struct {
	...
	// (Boolean) Allows deletion of the user. If false, the user cannot be deleted and the resource will be removed from the state on destruction. Defaults to false.
	...
	// (String) Name of the user, must be unique
